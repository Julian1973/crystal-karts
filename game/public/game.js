...
function setupMenuFlow(){
 ...
 for(const id of ['daily-start','garden-start','practice-start','ghost-start','sticker-open','online','cup-start','phone-setup'])$('flow-extras').append($(id));
