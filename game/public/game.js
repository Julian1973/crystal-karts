...
let gardenMode=new URLSearchParams(globalThis.location?.search||'').get('garden')==='1'&&new URLSearchParams(globalThis.location?.search||'').get('race')==='1',garden=null;const gardenMeshes=[];
...
function setupMenuFlow(){
 ...
 for(const id of ['garden-start','practice-start','ghost-start','sticker-open','online','cup-start','phone-setup'])$('flow-extras').append($(id));
